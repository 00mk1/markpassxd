#MarkPassxD v1.0.3 - A simple CLI Password Manager By Mark Barlass. 2022, FOSS, Use as you wish.
...
def main(logged_in):
    ...
    while True:
        ...
        if mode == '5':
            ...
            while invalid == True:
                try:
                    char_length = int(input("How Many Characters Should Be Included? (more = better, recommended: 128\n"))
                    invalid = False
                except:
